        ...
        <div className="min-h-screen flex bg-[#F5F5F5]">
            <div className="bg-black hidden lg:flex w-full lg:w-[588px] justify-center items-center">
                <div className="flex flex-col items-center">
                    <p className="text-white text-7xl font-semibold">Board.</p>
                </div>
            </div>
            <div className="flex w-full lg:w-[852px] justify-center items-center bg-[#F5F5F5] scale-[.80]">
                ...
                <div className="max-w-md mx-auto p-8">
                    <div className="font-montserrat text-lg lg:hidden text-center mb-4 w-full bg-black text-white p-2 rounded font-semibold relative">Board.</div>
                    <div className="font-semibold text-3xl">Sign In</div>
                    <div className="text-base text-gray-600">Sign in to your account</div>


                    <div className="flex mt-[20px] gap-[25px]">
                        <button className="w-[180px] h-[30px] flex-shrink-0 flex items-center gap-[10px] justify-center bg-white rounded-[10px] hover:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-gray-400">

                            <svg className="flex" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
                            ...
                            <p className="font-montserrat text-xs text-[#858585]">Sign in with Google</p>
                        </button>
                        <button className="w-[180px] h-[30px] flex-shrink-0 flex items-center gap-[10px] justify-center bg-white rounded-[10px] hover:bg-slate-200 focus:outline-none focus:ring-2 focus:ring-gray-400">
                            <svg className="flex" xmlns="http://www.w3.org/2000/svg" width="12" height="14" viewBox="0 0 12 14" fill="none">
                            ...
                            <p className="font-montserrat text-xs text-[#858585]">Sign in with Apple</p>
                        </button>
                    </div>
                        ...
                        <form>
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    className="w-full h-10 px-3 bg-gray-100 rounded-lg focus:outline-none focus:ring-2 focus:ring-slate-400"
                                />
                            </div>
                            <div className="mb-4">
